...
impl Mat4 {
    ...
    pub fn rotate_y(theta_y: f64) -> Mat4 {
        Mat4 {
            data: [[theta_y.cos(),  0., -theta_y.sin(), 0.],
                   [0.,             1., 0.,             0.],
    ...
    pub fn rotate_z(theta_z: f64) -> Mat4 {
        Mat4 {
            data: [[theta_z.cos(),  -theta_z.sin(), 0., 0.],
...
impl AddAssign<Mat4> for Mat4 {
    fn add_assign(&mut self, m: Mat4) {
        self.data = [[self.data[0][0] + m.data[0][0], self.data[0][1] + m.data[0][1], self.data[0][2] + m.data[0][2], self.data[0][3] + m.data[0][3]],
                    [self.data[1][0] + m.data[1][0], self.data[1][1] + m.data[1][1], self.data[1][2] + m.data[1][2], self.data[1][3] + m.data[1][3]],
                    [self.data[2][0] + m.data[2][0], self.data[2][1] + m.data[2][1], self.data[2][2] + m.data[2][2], self.data[2][3] + m.data[2][3]],
                    [self.data[3][0] + m.data[3][0], self.data[3][1] + m.data[3][1], self.data[3][2] + m.data[3][2], self.data[3][3] + m.data[3][3]]];
    }
...
impl Div<f64> for Mat4 {
    ...
    fn div(self, q: f64) -> Mat4 {
        Mat4 {
            data: [[self.data[0][0] / q, self.data[0][1]  / q, self.data[0][2]  / q, self.data[0][3]  / q],
                   [self.data[1][0] / q, self.data[1][1]  / q, self.data[1][2]  / q, self.data[1][3]  / q],
                   [self.data[2][0] / q, self.data[2][1]  / q, self.data[2][2]  / q, self.data[2][3]  / q],
                   [self.data[3][0] / q, self.data[3][1]  / q, self.data[3][2]  / q, self.data[3][3]  / q]],
        }
    }
}
